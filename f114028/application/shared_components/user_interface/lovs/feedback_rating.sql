...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(30826727003749404136)
,p_lov_name=>'FEEDBACK_RATING'
,p_lov_query=>'.'||wwv_flow_api.id(30826727003749404136)||'.'
,p_location=>'STATIC'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(30826727347930404137)
...
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(30826727752862404137)
...
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(30826728101542404138)
