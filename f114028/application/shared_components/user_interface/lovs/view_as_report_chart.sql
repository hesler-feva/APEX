...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(30826673855583403741)
,p_lov_name=>'VIEW_AS_REPORT_CHART'
,p_lov_query=>'.'||wwv_flow_api.id(30826673855583403741)||'.'
,p_location=>'STATIC'
);
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(30826674153171403741)
...
wwv_flow_api.create_static_lov_data(
 p_id=>wwv_flow_api.id(30826674532714403741)
